...
const CreatePost = () => {
  const [fileUploaded, setFileUploaded] = useState(false);
    ...
    const handleSubmit = async(e) => {
      ...
      const response = await axios.post("https://be-capstone-5rvf.onrender.com/seller/post/createpost", formData, {
    ...
    return (<div className=" mt-[30px] flex flex-col items-center">
      ...
      <button className='bg-rose-500 opacity-75 rounded-xl w-[250px] my-[20px] drop-shadow-md hover:cursor-pointer text-blue py-[15px] hover:opacity-100 bg-rose-600' type="submit"><h2>Create Post</h2></button>
      </form>
      </div>
